...
export default function Example() {
    ...
    const App = () => {
        ...
        const columns = [
            ...
            },
            {
                ...
                render: (_, record) => (
                    <Space size="middle">
                        <Button className={' border-amber-300 text-amber-400 hover:bg-amber-300 hover:text-white'} onClick={showModal} type='button'>
                            ตรวจสอบ/แก้ไข
                        </Button>
                    </Space>
                ),
  ...
  return (
    <div className="relative isolate overflow-hidden py-7 sm:py-12 lg:py-12 tracking-wider">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-8 gap-x-8 lg:mb-3 lg:max-w-none lg:grid-cols-2">
          ...
          <dl className="grid grid-cols-1 gap-x-0 lg:ml-20 gap-y-2 sm:grid-cols-2 lg:pt-2 ">
            <div className="flex flex-col lg:items-end">
                    <button onClick={showCalendar} type="button" class="mb-5 tracking-wider text-rose-700 bg-white shadow hover:text-rose-600 font-medium rounded-full text-sm px-20 py-4 text-center"><svg className='h-0 lg:h-8 ml-3 flex' fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div className="flex flex-col lg:items-end ">
                    <button onClick={showAdd} type="button" class="mb-5 tracking-wider text-rose-700 bg-white shadow hover:text-rose-600 font-medium rounded-full text-sm px-20 py-4 text-center"><svg className='h-0 lg:h-8 ml-3 flex' fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            >
                    ...
                    <div className='w-full text-end lg:items-center my-5 lg:my-0 lg:w-1/12'>
                        <button type="button" class=" text-rose-600 hover:bg-rose-700 shadow bg-orange-50 hover:text-white font-medium rounded-lg text-sm px-9 py-2.5 text-center inline-flex items-center mr-2">
