...
import { Form, Space, Table, Tag, Button, Modal, Card, Input, message, Popconfirm  } from 'antd'
...
export default function Example2() {
  ...
  const App = () => {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (_, record) => (
          <Space size="middle">
            <Button className={'hover:translate-1 hover:scale-110 duration-300 border-red-900 text-red-700 hover:bg-red-700 hover:text-white'} onClick={showModalList} type='button'>
              รายชื่อที่เข้าร่วม
            </Button>
          </Space>
        ),
  ...
  const confirm = (e) => {
    console.log(e);
    message.success('Click add student in event');
  };
  const cancel = (e) => {
    console.log(e);
      ...
      <Modal
        ...
        footer={[
          <div class="grid grid-cols-6 gap-4" >
            ...
            <p className='my-2 text-start'>50/80</p>
            <p className='my-2 col-span-2'>เพิ่มนักศึกษา</p>
            <input placeholder='รหัสนักศึกษา' type='number' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full  mr-2 mb-2 focus:ring-blue-500 focus:border-blue-500 px-8 py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            <Popconfirm
              title="Add the task"
              description="คุณต้องการเพิ่ม นางสาววิภาวดี ใจงาม หรือไม่?"
              onCancel={cancel}
              onConfirm={confirm}
              okText="Yes"
              cancelText="No"
            >
              <Button type="submit" className="text-white bg-green-600 hover:bg-green-800 w-1/2 focus:outline-none focus:ring-4 focus:ring-green-300 rounded-full text-sm pt-2.5 pb-8 text-center dark:bg-red-600 dark:hover:bg-red-800 dark:focus:ring-red-900">
             ค้นหา</Button>
            </Popconfirm>
