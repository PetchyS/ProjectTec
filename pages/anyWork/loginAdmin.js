                ...
                <div className="w-full max-w-md space-y-8">
                    <div>
                        <h2 className="mt-6 text-center text-3xl font-extralight tracking-tight text-gray-900">
                            Log in <span className='text-red-700'>( for admin )</span>
                        </h2>
                    ...
                    <form className="mt-8 space-y-6" action="#" method="POST">
                        ...
                        <div>
                            <button
                                type="submit"
                                className="group relative flex w-full justify-center rounded-full border border-transparent py-3 bg-red-600 text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                            >
                                <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                                    <LockClosedIcon className="h-5 w-5 text-red-800 group-hover:text-red-900" aria-hidden="true" />
                                </span>
                                เข้าสู่ระบบ
                            </button>
                            <a href='./main#'>
