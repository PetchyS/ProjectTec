        ...
        <>
            ...
            <div className="h-full py-6 px-4 align-item-center flex justify-center bg-slate-50 pb-72">
                <dl className="grid grid-cols-1 gap-x-40 lg:ml-20 gap-y-2 sm:grid-cols-3 lg:pt-2">
                        <div className=" ">
                            <button onClick={''} type="button" class="transition ease-in-out delay-150 mb-6 ml-2 mt-5 text-red shadow-2xl shadow-green-300/50 focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-full text-sm w-40 h-40 hover:-translate-y-1 hover:scale-110 hover:bg-green-100 duration-300" >
                        ...
                        <div className=" ">
                            <button onClick={''} type="button" class="transition ease-in-out delay-150 mb-6 ml-2 mt-5 text-blue shadow-xl shadow-blue-300/50 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-full text-sm w-40 h-40 hover:-translate-y-1 hover:scale-110 hover:bg-blue-100 duration-300">
                                <svg className='w-20 h-20 ml-10' fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
